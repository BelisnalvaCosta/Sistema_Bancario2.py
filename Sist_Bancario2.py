...
class PessoaFisica(Cliente):
    def __init__(self, nome, data_nascimento, cpf, endereco_residencia):
        super().__init__(endereco_residencia)
        self.nome = nome
...
class PessoaJuridica(Cliente):
    def __init__(self, nome, data_nascimento, cnpj, endereco_empresa):
        super().__init__(endereco_empresa)
        self.nome = nome
        self.data_nascimento = data_nascimento
        self.cnpj = cnpj
...
def criar_conta(numero_conta, clientes, contas):
    ...
    if not cliente:
        print("\n@@@ número de conta e cliente não encontrado, fluxo de criação de conta encerrada ou inexistente! @@@")
    return                 
